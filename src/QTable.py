...
class QTable():
	...
	def initTable(self, gridWidth, gridHeight,rangeLineOfSight,strengthLineOfSight,entities):
			#Get array of all polar states related to the Food
			allPolarStates = geometry.getAllPolarStatesRelatedToAPoint(gridWidth,gridHeight)
